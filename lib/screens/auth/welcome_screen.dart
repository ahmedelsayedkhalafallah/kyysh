...
import 'package:kyysh/blocs/sign_up_bloc/sign_up_bloc.dart';
import 'package:kyysh/screens/auth/sign_in_screen.dart';
import 'package:kyysh/screens/auth/sign_up_screen.dart';
                    ...
                    child: Column(
                      children: [
                        ...
                        Expanded(child: TabBarView(
                          controller: tabController,
                          children: [
                            BlocProvider<SignInBloc>(create: 
                            (context) => SignInBloc(
                              userRepository: context.read<AuthenticationBloc>().userRepository
                              ),
                              child: SignInScreen(),
                              ),
                            BlocProvider<SignUpBloc>(create: 
                            (context) => SignUpBloc(
                              userRepository: context.read<AuthenticationBloc>().userRepository
                              ),
                              child: SignUpScreen(),
